...
<form id="blog-form" action="{{ route('admin.blog.store') }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-lg shadow-md overflow-hidden" onsubmit="return prepareSubmit()">
    @csrf
    ...
    <div class="p-6 space-y-6">
        ...
        <div>
            ...
            <div class="mb-4">
                ...
                <p class="mt-1 text-xs text-gray-500">If unchecked, the post will be saved as a draft.</p>
            </div>
        </div>
