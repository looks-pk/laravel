...
<div class="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-slate-100">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center py-6">
                <div>
                    ...
                    <p class="mt-2 text-sm text-gray-600">Update and refine your content</p>
                </div>
                <div class="flex space-x-3">
                    ...
                    <a href="{{ route('admin.blog.create') }}" 
                       class="inline-flex items-center px-4 py-2 bg-green-600 border-2 border-green-600 rounded-lg text-sm font-medium text-white hover:bg-green-700 hover:border-green-700 transition-all duration-200">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <form id="blog-form" action="{{ route('admin.blog.update', $blog) }}" method="POST" enctype="multipart/form-data" 
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2 space-y-8">
                        ...
                        <div class="p-6 space-y-6">
                            ...
                            <div>
                                ...
                                <p class="mt-2 text-xs text-gray-500">
                                    The slug defines the URL structure for this post. Use lowercase letters, numbers, and hyphens only.
                                </p>
                            </div>
                            ...
                            <div class="mt-8">
                                @include('admin.blog.partials.sidebar-cards-builder', ['blog' => $blog])
                            </div>
                            ...
                            <div>
                                ...
                                <textarea name="excerpt" id="excerpt" rows="4" 
                                    ...
                                    placeholder="Write a compelling summary that will appear in search results and blog previews...">{{ old('excerpt', $blog->excerpt) }}</textarea>
                                <p class="mt-2 text-xs text-gray-500">
                    ...
                    <!-- SEO Section -->
                    <div class="form-section" x-data="{ seoOpen: {{ old('meta_title', $blog->meta_title) || old('meta_description', $blog->meta_description) || old('meta_keywords', $blog->meta_keywords) ? 'true' : 'false' }} }">
                        ...
                        <div x-show="seoOpen" x-collapse class="p-6 space-y-6">
                            ...
                            <div>
                                ...
                                <textarea name="meta_description" id="meta_description" rows="3" 
                                    class="input-field w-full px-4 py-3"
                                    placeholder="A compelling description that will appear in search engine results...">{{ old('meta_description', $blog->meta_description) }}</textarea>
                        ...
                        <div class="p-6">
                            @if($blog->featured_image)
                                <div class="mb-6">
                                    ...
                                    <div class="current-image w-full h-48">
                                ...
                                <div class="mt-4">
                                    <label for="featured_image" class="cursor-pointer">
                                        <span class="mt-2 block text-sm font-medium text-gray-900">
                                            {{ $blog->featured_image ? 'Upload new image' : 'Upload featured image' }}
                                        </span>
                        ...
                        <div class="p-6">
                            ...
                            @else
                                <p class="mt-3 text-xs text-gray-500">
                                    If checked, the post will be published immediately when saved.
                                </p>
                            @endif
                        </div>
                    </div>
