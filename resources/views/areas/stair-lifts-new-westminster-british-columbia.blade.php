...
@section('title', 'Luxury Stair Lifts in New Westminster, BC - Home2stay')
@section('meta_description', 'Luxury stair lifts in New Westminster, BC. Call today to schedule your free in-home consultation. Our experts are local, friendly, and ready to help you find the perfect service.')
    ...
    <div class="container mx-auto px-4 relative z-10">
        <div class="text-center">
            <h1 class="text-4xl md:text-6xl font-bold mb-6">
                Luxury Stair Lifts in New Westminster, BC
            </h1>
            <p class="text-xl md:text-2xl mb-8 opacity-90 max-w-3xl mx-auto">
                Call today to schedule your free in-home consultation. Our experts are local, friendly, and ready to help you find the perfect service.
            </p>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
                <h2 class="text-3xl md:text-4xl font-bold text-gray-900 section-title mb-8">
                    Professional Stair Lifts in New Westminster, BC
                </h2>
                <div class="prose prose-lg max-w-none">
                    <p class="text-lg text-gray-700 leading-relaxed mb-6">
                        If you or a loved one are finding stairs more challenging each day, you're not alone. Many families in New Westminster, BC, face the same issue. That's why we are here for your assistance. We provide expert services for safe and comfortable home access through professionally installed stairlifts in New Westminster.
                    </p>
                    <p class="text-gray-600 leading-relaxed mb-6">
                        With years of hands-on experience, our local team provides reliable stairlift installation, maintenance, and after-sales support. Whether your staircase is straight or curved, narrow or wide, indoors or outdoors, we have a lift designed just for you.
                    </p>
                    <p class="text-gray-600 leading-relaxed">
                        We take the time to assess your home and recommend the most practical and cost-effective option. All our lifts are smooth, quiet, and designed for comfort.
                    </p>
                </div>
            </div>
            <div class="map-container">
                <iframe 
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d83374.12345678901!2d-122.9102!3d49.2073!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x548677e0b2ae67ff%3A0x3a0e7c6c6e5b8c8c!2sNew%20Westminster%2C%20BC%2C%20Canada!5e0!3m2!1sen!2sus!4v1640995400000!5m2!1sen!2sus"
                    allowfullscreen="" 
                    loading="lazy" 
    ...
    <div class="container mx-auto px-4">
        <div class="text-center mb-12">
            <h2 class="text-3xl md:text-4xl font-bold text-gray-900 section-title mb-6">
                Contact Home2stay New Westminster
            </h2>
            <p class="text-xl text-gray-600 max-w-3xl mx-auto">
                Ready to make your New Westminster home safer and more accessible? Contact our local team for a free consultation and quote.
            </p>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div class="contact-card">
                ...
                <input type="hidden" name="form_type" value="assessment">
                    <input type="hidden" name="form_source" value="area-new-westminster_page_assessment_form">
                    ...
                    <div>
                        ...
                        <input type="text" id="city" name="city" placeholder="e.g., Queensborough, Uptown, Downtown" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                    </div>
...
<section class="py-16">
    <div class="container mx-auto px-6 lg:px-12 max-w-6xl">
        ...
        <div class="max-w-4xl mx-auto prose prose-lg">
            <p class="text-lg text-gray-700 leading-relaxed mb-6">
                New Westminster is a beautiful and vibrant city. But let's face it, many homes here are built on hills or have stairs that become a real challenge over time. Ageing, injuries, or health conditions can make stairs unsafe.
            </p>
            <p class="text-gray-600 leading-relaxed">
                That's exactly why more residents are choosing Stair Lifts in New Westminster, BC to stay in their homes longer and live more independently.
            </p>
        </div>
    </div>
</section>
...
<section class="py-16 bg-gray-50">
    <div class="container mx-auto px-6 lg:px-12 max-w-6xl">
        <h2 class="text-3xl md:text-4xl font-bold text-gray-900 section-title mb-8 text-center">
            Stairlifts in New Westminster, BC
        </h2>
        <div class="max-w-4xl mx-auto mb-12">
            <p class="text-lg text-gray-700 leading-relaxed mb-6 text-center">
                Every staircase is different, and so is every user. The solution we offer doesn't fit all. We carry a variety of stairlifts that meet the needs of every client. Whether you need a stairlift for short-term recovery or long-term comfort, we're here to guide you with clarity and care.
            </p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="service-card p-8 text-center">
                ...
                <h3 class="text-xl font-bold text-gray-900 mb-4">Commercial Stairlifts in New Westminster, BC</h3>
                <p class="text-gray-600">
                    Businesses must be accessible to everyone. Installing Stair Lifts in New Westminster commercial buildings ensures that customers, staff, and visitors can move around safely and confidently. Our commercial-grade stairlifts are designed for high-traffic use and meet safety regulations.
                </p>
            </div>
            ...
            <div class="service-card p-8 text-center">
                ...
                <h3 class="text-xl font-bold text-gray-900 mb-4">New Westminster After-Hours Support</h3>
                <p class="text-gray-600">
                    Got a problem at night or during the weekend? We've got your back. Our team is available for after-hours calls.
                </p>
            </div>
            ...
            <div class="service-card p-8 text-center">
                ...
                <h3 class="text-xl font-bold text-gray-900 mb-4">New Westminster Device & Regular Maintenance</h3>
                <p class="text-gray-600">
                    Prevent breakdowns before they happen. Our regular maintenance plans keep your lift running smoothly for years.
                </p>
            </div>
        </div>
    </div>
...
<section class="py-16">
    <div class="container mx-auto px-6 lg:px-12 max-w-6xl">
        <h2 class="text-3xl md:text-4xl font-bold text-gray-900 section-title mb-8 text-center">
            Residential Stair Lifts in New Westminster, BC
        </h2>
        <p class="text-lg text-gray-600 mb-12 text-center max-w-3xl mx-auto">
            Home should feel like a place of comfort, not a place with barriers. Our residential Stair Lifts in New Westminster, BC restore mobility without making your home look or feel like a hospital.
        </p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="service-card p-8">
                ...
                <p class="text-gray-600">
                    Customized for staircases with turns or landings. Designed to fit your stairs, not the other way around.
                </p>
            </div>
            ...
            <div class="service-card p-8">
                ...
                <p class="text-gray-600">
                    Perfect for straight staircases. Comfortable, compact, and easy to operate.
                </p>
            </div>
            ...
            <div class="service-card p-8">
                ...
                <h3 class="text-xl font-bold text-gray-900 mb-4">Commercial Models</h3>
                <div class="text-gray-600 space-y-3">
                    <p><strong>Stannah 260 Business (Indoor):</strong> Ideal for curved staircases in public areas. Strong, smooth, and reliable.</p>
                    <p><strong>K2 Plus Commercial:</strong> Perfect for straight staircases in offices, shops, or other public places. Space-saving and budget-friendly.</p>
                    <p><strong>Stairfriend Commercial:</strong> Custom-built for complex layouts. Durable, quiet, and ideal for commercial settings.</p>
                </div>
            </div>
        </div>
    </div>
...
<section class="py-16 bg-gray-50">
    <div class="container mx-auto px-6 lg:px-12 max-w-6xl">
        <h2 class="text-3xl md:text-4xl font-bold text-gray-900 section-title mb-8 text-center">
            Types of Stair Lifts | Housing Styles | New Westminster, BC
        </h2>
        <p class="text-lg text-gray-600 mb-12 text-center max-w-3xl mx-auto">
            Stair Lifts Contractors in New Westminster come in all styles: character homes, condos, townhouses, and duplexes. Whatever your home's layout, we'll help you choose a stairlift that fits both your space and your lifestyle.
        </p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="service-card p-8">
                ...
                <h3 class="text-xl font-bold text-gray-900 mb-4">Indoor & Outdoor Solutions</h3>
                <p class="text-gray-600">
                    We offer: Indoor stair lifts, outdoor stair lifts, straight rail systems, curved rail systems, and compact and folding designs for narrow staircases.
                </p>
            </div>
        </div>
    </div>
...
<section class="py-16">
    <div class="container mx-auto px-6 lg:px-12 max-w-6xl">
        ...
        <p class="text-lg text-gray-600 mb-12 text-center max-w-3xl mx-auto">
            We believe in more than just selling stairlifts. We're your partners in safe living. Here's what we offer:
        </p>

        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div class="service-card p-6">
                <h3 class="text-lg font-bold text-gray-900 mb-3">Free In-Home Consultation</h3>
                <p class="text-gray-600">Our experts assess your staircase and recommend the best solution</p>
            </div>

            <div class="service-card p-6">
                <h3 class="text-lg font-bold text-gray-900 mb-3">Fast, Expert Installation</h3>
                <p class="text-gray-600">Skilled technicians ensure your stairlift is installed safely and efficiently</p>
            </div>

            <div class="service-card p-6">
                <h3 class="text-lg font-bold text-gray-900 mb-3">Custom-Fit Stairlifts</h3>
                <p class="text-gray-600">Every installation is customized to your specific staircase and needs</p>
            </div>

            <div class="service-card p-6">
                <h3 class="text-lg font-bold text-gray-900 mb-3">Service Trouble Calls</h3>
                <p class="text-gray-600">Call us if your lift ever stops or makes unusual sounds. We'll be there fast with solutions</p>
            </div>

            <div class="service-card p-6">
                <h3 class="text-lg font-bold text-gray-900 mb-3">Affordable Financing Options</h3>
                <p class="text-gray-600">Flexible payment plans to make stairlifts accessible to everyone</p>
            </div>

            <div class="service-card p-6">
                <h3 class="text-lg font-bold text-gray-900 mb-3">Local Technicians You Can Trust</h3>
                <p class="text-gray-600">Our experienced team provides reliable service and ongoing support</p>
            </div>
        </div>

        <p class="text-gray-600 text-center mt-8 max-w-2xl mx-auto">
            We proudly serve the entire New Westminster region, including: Lower Mainland, Vancouver, Surrey, Abbotsford, Richmond, Coquitlam, Port Moody, Tri-Cities, Mission, Delta, Pitt Meadows, Burnaby, Chilliwack, White Rock, Aldergrove, Maple Ridge and Langley! No matter your neighbourhood, we bring fast, friendly, and reliable service right to your door.
        </p>
    </div>
</section>
...
<section class="py-16 bg-gradient-to-r from-blue-600 to-blue-700 text-white">
    <div class="container mx-auto px-4 text-center">
        ...
        <p class="text-xl mb-8 max-w-3xl mx-auto opacity-90">
            Our mission is simple: help you feel safe, confident, and mobile at home or work. Don't wait for an accident to happen. A stairlift is a smart investment in your independence and safety.
        </p>
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            Frequently Asked Questions
             ...
             <div class="faq-item">
                 <button class="faq-question" type="button">
                     <span>What are the benefits of installing a stairlift in New Westminster?</span>
                 ...
                 <div class="faq-answer">
                     <div class="faq-answer-content">
                         Installing a stairlift means staying in the home you love, avoiding the cost of assisted living, moving around safely and independently, reducing the risk of falls, and feeling more confident every day. It's not just about convenience, it's about dignity and peace of mind.
                     </div>
                 </div>
             </div>
             ...
             <div class="faq-item">
                 <button class="faq-question" type="button">
                     <span>What brands of stairlifts do you offer?</span>
                     <svg class="faq-icon w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                         <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                     </svg>
                 </button>
                 <div class="faq-answer">
                     <div class="faq-answer-content">
                         We only work with trusted brands that are known for safety and comfort. Our lineup includes Stannah, Handicare, Bruno, and Savaria. Each model is tested, certified, and backed by solid warranties. We don't cut corners because your safety matters.
                     </div>
                 </div>
             </div>
             ...
             <div class="faq-item">
                 <button class="faq-question" type="button">
                     <span>Do you offer commercial stairlift installation?</span>
                     <svg class="faq-icon w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                         <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                     </svg>
                 </button>
                 <div class="faq-answer">
                     <div class="faq-answer-content">
                         Yes, we provide commercial stairlift solutions including Stannah 260 Business (ideal for curved staircases in public areas), K2 Plus Commercial (perfect for straight staircases in offices and shops), and Stairfriend Commercial (custom-built for complex layouts). All meet safety regulations for commercial use.
                     </div>
                 </div>
             </div>
             ...
             <div class="faq-item">
                 <button class="faq-question" type="button">
                     <span>How do I get started with a stairlift in New Westminster?</span>
                     <svg class="faq-icon w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                         <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                     </svg>
                 </button>
                 <div class="faq-answer">
                     <div class="faq-answer-content">
                         Simply call us for a free in-home consultation. Our local team will visit your home, assess your staircase, and recommend the perfect solution for your needs and budget. Whether you're helping a parent or planning for your future, you'll love the peace of mind our services bring.
                     </div>
                 </div>
             </div>
         </div>
