...
@section('title', 'Reliable Stair Lifts in Port Coquitlam, BC - Home2stay')
@section('meta_description', 'Professional stair lifts in Port Coquitlam, BC. Expert installation and reliable service. Your safe and independent future starts here. Call now!')
    ...
    <div class="container mx-auto px-4 relative z-10">
        <div class="text-center">
            <h1 class="text-4xl md:text-6xl font-bold mb-6">
                Reliable Stair Lifts in Port Coquitlam, BC
            </h1>
            <p class="text-xl md:text-2xl mb-8 opacity-90 max-w-3xl mx-auto">
                We're your best experts for Stair Lifts in Port Coquitlam, BC. Your safe and independent future starts right here.
            </p>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
                <h2 class="text-3xl md:text-4xl font-bold text-gray-900 section-title mb-8">
                    Professional Stair Lifts in Port Coquitlam, BC
                </h2>
                <div class="prose prose-lg max-w-none">
                    <p class="text-lg text-gray-700 leading-relaxed mb-6">
                        When do you want the best stairlift services in Port Coquitlam, BC? We're your best partner for the stair lift in Port Coquitlam. We offer professionally fitted stairlifts that enable you or your family member to live independently at home.
                    </p>
                    <p class="text-gray-600 leading-relaxed mb-6">
                        All steps are important, and we're here to make them safe again. Our team is qualified, certified, and here to make movement simpler. We have the best quality stair lifts for you and your home, lifestyle, and budget.
                    </p>
                    <p class="text-gray-600 leading-relaxed">
                        We're committed to making the entire process an easy one from the moment you call us to the moment you have a new system in place at your home or business.
                    </p>
                </div>
            </div>
            <div class="map-container">
                <iframe 
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d41726.32584920395!2d-122.7809!3d49.2628!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x548679ac92e8a92f%3A0x98e0b1bcfd7e7bd0!2sPort%20Coquitlam%2C%20BC%2C%20Canada!5e0!3m2!1sen!2sus!4v1640995400000!5m2!1sen!2sus"
                    allowfullscreen="" 
                    loading="lazy" 
    ...
    <div class="container mx-auto px-4">
        <div class="text-center mb-12">
            <h2 class="text-3xl md:text-4xl font-bold text-gray-900 section-title mb-6">
                Contact Home2stay Port Coquitlam
            </h2>
            <p class="text-xl text-gray-600 max-w-3xl mx-auto">
                Ready to make your Port Coquitlam home safer and more accessible? Contact our local team for a free consultation and quote.
            </p>
        </div>
            ...
            <div class="contact-card">
                ...
                <input type="hidden" name="form_type" value="assessment">
                    ...
                    <div>
                        ...
                        <input type="text" id="city" name="city" placeholder="e.g., Citadel, Riverwood, Lincoln Park" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                    </div>
...
<section class="py-16">
    <div class="container mx-auto px-6 lg:px-12 max-w-6xl">
        ...
        <div class="max-w-4xl mx-auto prose prose-lg">
            <p class="text-lg text-gray-700 leading-relaxed mb-6">
                Port Coquitlam has a nice mix of old and new homes in a beautiful but rapidly growing city. Homeowners here are increasingly choosing to age in place as the population ages. That's where our stair lifts come in.
            </p>
            <p class="text-gray-600 leading-relaxed mb-6">
                Our goal is to offer the highest quality stair lift along with an exceptional customer experience. If the stairs are becoming too much, we can help find the perfect stairlift options for you.
            </p>
            <p class="text-gray-600 leading-relaxed">
                We are experts in Stair Lifts in Port Coquitlam that solve real problems. These are not one-size-fits-all devices. Your staircase no longer has to be an obstacle to your freedom.
            </p>
        </div>
    </div>
</section>
...
<section class="py-16 bg-gray-50">
    <div class="container mx-auto px-6 lg:px-12 max-w-6xl">
        <h2 class="text-3xl md:text-4xl font-bold text-gray-900 section-title mb-8 text-center">
            Stair Climbing Assistance in Port Coquitlam, BC
        </h2>
        <div class="max-w-4xl mx-auto mb-12">
            <p class="text-lg text-gray-700 leading-relaxed mb-6 text-center">
                We can restore access to your entire home safely. We even have outdoor services. And we don't drop it off and leave. We guide you through everything from safety features to operating without a sweat.
            </p>
            <p class="text-gray-600 leading-relaxed text-center">
                If you need Stair Lifts Dealers in Port Coquitlam, then our professional staff are highly experienced and ready to help you with honest and fast service.
            </p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="service-card p-8 text-center">
                ...
                <h3 class="text-xl font-bold text-gray-900 mb-4">Commercial Stairlifts in Port Coquitlam, BC</h3>
                <p class="text-gray-600">
                    If you need any type of stair lift for a commercial space? We find reliable options that meet all safety regulations while maintaining comfort and ease of use.
                </p>
            </div>
            ...
            <div class="service-card p-8 text-center">
                ...
                <h3 class="text-xl font-bold text-gray-900 mb-4">Port Coquitlam, BC After Hours Support</h3>
                <p class="text-gray-600">
                    We provide ongoing service to keep your lift safe and reliable. A well-maintained lift lasts longer and performs better every day.
                </p>
            </div>
            ...
            <div class="service-card p-8 text-center">
                ...
                <h3 class="text-xl font-bold text-gray-900 mb-4">Port Coquitlam, BC Device & Regular Maintenance</h3>
                <p class="text-gray-600">
                    If anything goes wrong, we respond fast. Our technicians are local, skilled, and ready to get your lift working like new again.
                </p>
            </div>
        </div>
    </div>
...
<section class="py-16">
    <div class="container mx-auto px-6 lg:px-12 max-w-6xl">
        <h2 class="text-3xl md:text-4xl font-bold text-gray-900 section-title mb-8 text-center">
            Residential Stair Lifts in Port Coquitlam, BC
        </h2>
        <p class="text-lg text-gray-600 mb-12 text-center max-w-3xl mx-auto">
            Your house should feel like a haven of tranquillity from top to bottom. Our stair lifts at home ensure it. With quiet operation, simple control and clean lines, you'll barely know it's there.
        </p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="service-card p-8">
                ...
                <p class="text-gray-600">
                    Got curved stairs? No problem. The Stannah 260 is smooth, secure, and custom-made for your stairs. It's a top choice for many homes in Port Coquitlam.
                </p>
            </div>
            ...
            <div class="service-card p-8">
                ...
                <p class="text-gray-600">
                    If you have a straight staircase, this one's for you. It's slim, strong, and fits most homes perfectly. The ride is smooth, and the controls are easy, even for arthritic hands.
                </p>
            </div>
            ...
            <div class="service-card p-8">
                ...
                <div class="text-gray-600 space-y-3">
                    <p><strong>Stannah 260 Business (Indoor):</strong> This is ideal for curved stairs in business settings. Durable, stylish and safe, it runs smoothly and is built for high-traffic use. Its seat is comfortable, and it parks neatly when not in use.</p>
                    <p><strong>K2 Plus Commercial:</strong> Perfect for straight stairs. This model is compact, modern, and easy to use. It's designed for offices, clinics, and other public spaces needing accessibility solutions.</p>
                    <p><strong>Stairfriend Commercial:</strong> Customised for custom staircases. Whether you've got landings or turns, Stairfriend handles it all. It's a reliable lift that integrates with your interior while offering consistent performance.</p>
                </div>
            </div>
        </div>
    </div>
...
<section class="py-16 bg-gray-50">
    <div class="container mx-auto px-6 lg:px-12 max-w-6xl">
        <h2 class="text-3xl md:text-4xl font-bold text-gray-900 section-title mb-8 text-center">
            Types of Stair Lifts | Housing Styles | Port Coquitlam, BC
        </h2>
        <p class="text-lg text-gray-600 mb-12 text-center max-w-3xl mx-auto">
            Every home is different. That's why we offer a variety of lifts that suit all home styles, bungalows, duplexes, condos, and heritage homes. We've installed lifts in every kind of home in Port Coquitlam, and we know what works best where.
        </p>
...
<section class="py-16">
    <div class="container mx-auto px-6 lg:px-12 max-w-6xl">
        ...
        <p class="text-lg text-gray-600 mb-12 text-center max-w-3xl mx-auto">
            We don't just install stair lifts. We take care of everything from start to finish and beyond. When you choose us, you get peace of mind. We're with you every step of the way.
        </p>
        ...
        <p class="text-gray-600 text-center mt-8 max-w-2xl mx-auto">
            We proudly serve every neighbourhood in the Lower Mainland, Vancouver, Surrey, Abbotsford, Richmond, Coquitlam, Port Moody, Tri-Cities, Mission, Delta, Pitt Meadows, Burnaby, Chilliwack, White Rock, Aldergrove, Maple Ridge and Langley. We also extend services to nearby areas, so no matter where you are, help is close by.
        </p>
    </div>
</section>
...
<section class="py-16 bg-gradient-to-r from-blue-600 to-blue-700 text-white">
    <div class="container mx-auto px-4 text-center">
        ...
        <p class="text-xl mb-8 max-w-3xl mx-auto opacity-90">
            Don't wait for the stairs to become a danger. Give your home the upgrade it deserves today. Call now to schedule your free consultation!
        </p>
        <p class="text-lg mb-8 max-w-2xl mx-auto">
            Let's bring safety, comfort, and freedom back to your daily life. Free in-home consultations, fast professional installation, and lifetime service support.
        </p>
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            Frequently Asked Questions
             ...
             <div class="faq-item">
                 <button class="faq-question" type="button">
                     <span>How much should I pay for a stair lift?</span>
                 ...
                 <div class="faq-answer">
                     <div class="faq-answer-content">
                         Prices vary based on your stairs and model. We offer affordable options for all budgets, including financing.
                     </div>
                 </div>
             </div>
             ...
             <div class="faq-item">
                 <button class="faq-question" type="button">
                     <span>What is the average cost of stair lifts?</span>
                     <svg class="faq-icon w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                         <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                     </svg>
                 </button>
             ...
             <div class="faq-item">
                 <button class="faq-question" type="button">
                     <span>What can seniors do instead of stair lifts?</span>
                     <svg class="faq-icon w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                         <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                     </svg>
                 </button>
                 <div class="faq-answer">
                     <div class="faq-answer-content">
                         If a stair lift isn't the right fit, home elevators, ramps, or downsizing to a single-floor living space are alternatives. But for many, a stair lift is the easiest and most cost-effective solution.
                     </div>
                 </div>
             </div>
             ...
             <div class="faq-item">
                 ...
                 <div class="faq-answer">
                     <div class="faq-answer-content">
                         Start with a free consultation. We'll measure your stairs, understand your needs, and recommend the best fit, straight, curved, or outdoor.
                     </div>
                 </div>
             </div>
             ...
             <div class="faq-item">
                 <button class="faq-question" type="button">
                     <span>What is the best stair lift?</span>
                     <svg class="faq-icon w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                         <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                     </svg>
                 </button>
                 <div class="faq-answer">
                     <div class="faq-answer-content">
                         It depends on your staircase and personal needs. Stannah models are popular due to their reliability, design, and comfort. We'll help you choose the best stair lift for your space.
                     </div>
                 </div>
             </div>
         </div>
