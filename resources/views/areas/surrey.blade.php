...
@section('title', 'Surrey Accessibility Solutions - Home2stay')
@section('meta_description', 'Home2stay Surrey provides professional accessibility solutions including stairlifts, grab bars, wheelchair ramps, and bathroom modifications throughout Surrey and the Fraser Valley region.')
    ...
    <div class="container mx-auto px-4 relative z-10">
        <div class="text-center">
            ...
            <p class="text-xl md:text-2xl mb-8 opacity-90 max-w-3xl mx-auto">
                Professional accessibility solutions for Surrey and the Fraser Valley region
            </p>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
                <h2 class="text-3xl md:text-4xl font-bold text-gray-900 section-title mb-8">
                    Serving Surrey & Fraser Valley
                </h2>
                <div class="prose prose-lg max-w-none">
                    <p class="text-lg text-gray-700 leading-relaxed mb-6">
                        Home2stay Surrey is proud to serve the diverse communities throughout Surrey, White Rock, Langley, and the broader Fraser Valley region. Our local team understands the unique needs of Lower Mainland residents and is committed to providing accessible solutions that enhance independence and safety.
                    </p>
                    <p class="text-gray-600 leading-relaxed mb-6">
                        From the bustling neighborhoods of Guildford and Newton to the family-friendly communities of Fleetwood and South Surrey, we bring professional accessibility services directly to your home. Our certified technicians are familiar with local building codes and regulations, ensuring all installations meet the highest safety standards.
                    </p>
                    <p class="text-gray-600 leading-relaxed">
                        Whether you're planning ahead for aging in place or need immediate accessibility modifications, our Surrey team provides personalized consultations and expert installations tailored to your specific needs and home layout.
                    </p>
                </div>
            </div>
    ...
    <div class="container mx-auto px-4">
        <div class="text-center mb-12">
            ...
            <p class="text-xl text-gray-600 max-w-3xl mx-auto">
                Comprehensive accessibility solutions designed to help you maintain independence and safety in your Surrey home
            </p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="service-card p-8">
                ...
                <h3 class="text-xl font-bold text-gray-900 mb-4">Stairlifts</h3>
                <p class="text-gray-600 mb-6 flex-grow">
                    Custom stairlift installations for straight and curved staircases. Indoor and outdoor options available with professional installation and ongoing maintenance support.
                </p>
                <a href="{{ route('products.show', 'stairlifts') }}" class="btn-primary">
                    Learn More
            ...
            <div class="service-card p-8">
                ...
                <h3 class="text-xl font-bold text-gray-900 mb-4">Grab Bars & Safety Rails</h3>
                <p class="text-gray-600 mb-6 flex-grow">
                    Professional installation of grab bars, safety rails, and support systems throughout your home. Bathroom, hallway, and stairway safety solutions.
                </p>
                <a href="{{ route('products.show', 'grab-bars') }}" class="btn-primary">
                    Learn More
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 ml-2" viewBox="0 0 20 20" fill="currentColor">
                        <path fill-rule="evenodd" d="M12.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-2.293-2.293a1 1 0 010-1.414z" clip-rule="evenodd" />
                    </svg>
            ...
            <div class="service-card p-8">
                <div class="service-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="w-8 h-8">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 21l1.65-3.8a9 9 0 118.35 0L15 21M9 10h6" />
                    </svg>
                </div>
                <h3 class="text-xl font-bold text-gray-900 mb-4">Wheelchair Ramps</h3>
                <p class="text-gray-600 mb-6 flex-grow">
                    Custom wheelchair ramps and accessibility ramps for home entrances, decks, and porches. Permanent and portable solutions available.
                </p>
                <a href="{{ route('products.show', 'ramps') }}" class="btn-primary">
                    Learn More
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 ml-2" viewBox="0 0 20 20" fill="currentColor">
                        <path fill-rule="evenodd" d="M12.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-2.293-2.293a1 1 0 010-1.414z" clip-rule="evenodd" />
                    </svg>
            ...
            <div class="service-card p-8">
                ...
                <h3 class="text-xl font-bold text-gray-900 mb-4">Bathroom Modifications</h3>
                <p class="text-gray-600 mb-6 flex-grow">
                    Complete bathroom accessibility modifications including walk-in tubs, roll-in showers, raised toilets, and accessible vanities.
                </p>
                <a href="{{ route('products.show', 'bathroom-safety') }}" class="btn-primary">
                    Learn More
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 ml-2" viewBox="0 0 20 20" fill="currentColor">
                        <path fill-rule="evenodd" d="M12.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-2.293-2.293a1 1 0 010-1.414z" clip-rule="evenodd" />
                    </svg>
            ...
            <div class="service-card p-8">
                ...
                <h3 class="text-xl font-bold text-gray-900 mb-4">Home Assessments</h3>
                <p class="text-gray-600 mb-6 flex-grow">
                    Comprehensive home safety and accessibility assessments by certified professionals. Identify potential hazards and accessibility improvements.
                </p>
                <a href="{{ route('services.show', 'assessments') }}" class="btn-primary">
                    Learn More
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 ml-2" viewBox="0 0 20 20" fill="currentColor">
                        <path fill-rule="evenodd" d="M12.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-2.293-2.293a1 1 0 010-1.414z" clip-rule="evenodd" />
                    </svg>
            ...
            <div class="service-card p-8">
                ...
                <h3 class="text-xl font-bold text-gray-900 mb-4">Mobility Equipment</h3>
                <p class="text-gray-600 mb-6 flex-grow">
                    Wide selection of mobility aids including walkers, wheelchairs, scooters, and daily living aids. Sales, rentals, and service available.
                </p>
                <a href="{{ route('products.show', 'mobility-aids') }}" class="btn-primary">
                    Learn More
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 ml-2" viewBox="0 0 20 20" fill="currentColor">
                        <path fill-rule="evenodd" d="M12.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-2.293-2.293a1 1 0 010-1.414z" clip-rule="evenodd" />
                    </svg>
...
<section id="contact" class="py-16 bg-gray-50">
    <div class="container mx-auto px-4">
        <div class="text-center mb-12">
            ...
            <p class="text-xl text-gray-600 max-w-3xl mx-auto">
                Ready to make your Surrey home more accessible? Contact our local team for a free consultation and quote.
            </p>
        </div>
                    ...
                    <div class="flex items-start space-x-4">
                        ...
                        <div>
                            ...
                            <ul class="text-gray-700 space-y-1">
                                <li>• Surrey (All Districts)</li>
                                <li>• White Rock</li>
                                <li>• Langley & Langley Township</li>
                                <li>• Delta</li>
                                <li>• Richmond (South)</li>
                                <li>• Burnaby (South)</li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="contact-card">
                ...
                <form class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="city" name="city" placeholder="e.g., Guildford, Newton, Fleetwood" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                    </div>
