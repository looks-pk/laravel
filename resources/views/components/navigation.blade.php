...
.bg-primary\/5 { background-color: rgba(0, 120, 191, 0.05) !important; }
.bg-primary\/10 { background-color: rgba(0, 120, 191, 0.1) !important; }
.bg-primary\/20 { background-color: rgba(0, 120, 191, 0.2) !important; }
</style>
        ...
        <div class="flex justify-between items-center">
            ...
            <div class="hidden lg:flex items-center justify-center mx-auto">
                <div class="flex items-center space-x-8">
                    ...
                    <a href="{{ route('home') }}" class="nav-link px-3 py-2 rounded-lg text-gray-700 hover:text-primary hover:bg-primary/5 transition-all duration-200 font-medium whitespace-nowrap {{ request()->routeIs('home') ? 'active text-primary bg-primary/10' : '' }}">
                        Home
                    </a>

                    <!-- Products Dropdown -->
                    <div class="relative group">
                        <button class="nav-link flex items-center px-3 py-2 rounded-lg text-gray-700 hover:text-primary hover:bg-primary/5 transition-all duration-200 font-medium whitespace-nowrap {{ request()->is('products-categories/*') || request()->is('all-products*') ? 'active text-primary bg-primary/10' : '' }}">
                            Products
                        ...
                        <!-- Centered Responsive Dropdown Menu -->
                        <div class="absolute left-1/2 -translate-x-1/2 w-[90vw] max-w-6xl bg-white rounded-xl shadow-2xl py-8 hidden group-hover:block z-50 border border-gray-100 mt-2">
                            <div class="px-8">
                                <div class="grid grid-cols-4 gap-6">

                                    <!-- Column 1: Mobility & Lifts -->
                                    <div class="space-y-3">
                                    ...
                                    <div class="space-y-3">
                                        ...
                                        <a href="/all-products/" class="flex items-center p-2 text-gray-700 hover:bg-primary/5 border border-primary/20 rounded-lg transition-colors group/item bg-primary/5">
                    ...
                    <!-- About Us Dropdown -->
                    <div class="relative group">
                        <button class="nav-link flex items-center px-3 py-2 rounded-lg text-gray-700 hover:text-primary hover:bg-primary/5 transition-all duration-200 font-medium whitespace-nowrap {{ request()->is('company-profile*') || request()->is('about-us*') || request()->is('about*') ? 'active text-primary bg-primary/10' : '' }}">
                            About Us
                            <svg class="w-4 h-4 ml-1.5 transition-transform duration-200 group-hover:rotate-180" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                            </svg>
                        ...
                        <div class="absolute right-0 w-80 bg-white rounded-xl shadow-2xl py-6 hidden group-hover:block z-40 border border-gray-100 mt-2">
                            <div class="px-6 space-y-3">
                                <a href="/company-profile" class="block p-2 text-gray-700 hover:bg-gray-50 rounded-lg transition-colors">
                                    <div class="font-medium text-gray-900 text-sm">Company Profile</div>
                                    <div class="text-xs text-gray-500">Learn about our mission and history</div>
                                </a>
                                <a href="{{ route('contact') }}" class="block p-2 text-gray-700 hover:bg-gray-50 rounded-lg transition-colors">
                                    <div class="font-medium text-gray-900 text-sm">Contact Us</div>
                                    <div class="text-xs text-gray-500">Get in touch with our expert team</div>
                                </a>
                            </div>
                        </div>
                    </div>
