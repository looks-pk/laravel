    ...
    <div class="lg:hidden hidden mobile-menu" id="mobile-menu">
        <div class="px-4 pt-4 pb-6 space-y-2 bg-white/98 backdrop-blur-md border-t border-gray-200/50">
            ...
            <div class="flex flex-col space-y-3 mt-6 px-4">
                <a href="/locations" class="btn-primary py-3 text-center rounded-lg text-sm font-medium">Visit a Location</a>
                <a href="{{ route('contact') }}" class="btn-secondary py-3 text-center rounded-lg text-sm font-medium">Contact Us Today</a>
            </div>
        </div>
    </div>
</nav>
