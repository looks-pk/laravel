...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&display=swap" rel="preload"
    ...
    <script src="https://www.google.com/recaptcha/api.js?render={{ config('services.recaptcha.site_key') }}" async
        defer></script>
    ...
    <script type='text/javascript'
        src='data:text/javascript;base64,'>
        </script>
...
<body class="font-sans antialiased">
                        ...
                        <div class="flex-shrink-0 mb-4">
                            <a href="{{ route('home') }}" class="flex items-center">
                                <span class="text-2xl font-bold text-primary">
                                    <img data-lazy="/logo/logo-light.png" alt="Home2stay Logo" class="lazy-image"
                ...
                <div class="border-t border-gray-800 mt-12 pt-8">
                    <div class="flex flex-col md:flex-row justify-between items-center text-light-800 text-xl">
                        ...
                        <div class="flex items-center text-center md:text-right">
                            ...
                            <a href="https://digitalpartner.ca/" target="_blank" rel="nofollow noopener noreferrer"
                                class="hover:opacity-80 transition-opacity">
                                <img data-lazy="https://digitalpartner.ca/wp-content/uploads/2023/11/logo.png"
                                    alt="Digital Partner" class="lazy-image w-12 h-12 object-contain">
    ...
    <script id="zsiqscript" src="https://salesiq.zohopublic.com/widget?wc=siq0bfa14f5f94a3227de3e9b2cab83f1f85d3973a6accac513dd1e254aea3dd21c84671c3c49de10717181e6f1badeb55d" defer></script>
