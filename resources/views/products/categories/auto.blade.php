...
@section('title', 'Automotive Accessibility Products')
@section('meta_description', 'Discover our specialized automotive accessibility solutions designed to enhance mobility and independence for individuals with different abilities.')
            ...
            <div class="bg-gray-50 rounded-xl overflow-hidden shadow-lg">
                <div class="flex flex-col lg:flex-row">
                    ...
                    <div class="w-full lg:w-1/2 p-8 md:p-12 flex flex-col justify-center">
                        ...
                        <p class="mb-5">Is your area not listed? Give us a call at <a
                                href="tel:+16042591211" class="text-secondary">604-259-1211</a> or submit a FREE
