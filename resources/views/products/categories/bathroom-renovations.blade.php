            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div
                    ...
                    <div class="overflow-hidden relative">
                        <img class="w-full object-cover" src="{{ asset('bestbath/8.jpeg') }}" alt="Shower Bay Portable Accessible Shower"
                            style="height: 300px;">
                    ...
                    <a href="{{ route('products.show', 'custom-tile-and-stone-showers-installation') }}" > <h3 class="text-xl font-bold text-gray-800 mb-3">Custom Tiles Bathroom & Showers</h3></a>
                        ...
                        <div class="mt-auto">
                            <a href="/products-categories/custom-tile-and-stone-showers-installation/"
                ...
                <div
                    ...
                    <div class="p-6 flex-1 flex flex-col">
                    <a href="{{ route('products.show', 'bestbath-modular-barrier-free-showers') }}" > <h3 class="text-xl font-bold text-gray-800 mb-3">Best Bath Modular Showers System</h3></a>
