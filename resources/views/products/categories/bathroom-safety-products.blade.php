...
@section('title', 'Bathroom Safety Products Vancouver | Best Bath Services | Home2stay')
@section('meta_description', 'Trusted bathroom safety products Vancouver and best bath services. Expert installation of grab bars, shower chairs, bath and toilet safety accessories for safer homes.')
...
@section('content')
    ...
    <section class="relative bg-gray-900 overflow-hidden" style="min-height: 500px;">
        ...
        <div class="container mx-auto px-4 relative z-10 flex items-center mb-4 mt-4" style="min-height: 500px;">
            <div class="max-w-3xl">
                <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">Best Bath Services Vancouver | Home2stay</h1>
                <p class="text-xl text-white/90 mb-8">
                    A secure bathroom is important in every house. We assist the family in designing bathrooms that are safe, easy, and simple to use. Our team provides reliable upgrades of the bath, safety, and adapted measures. You have arrived at the right place to have the Best Bath Services Vancouver. Many families also search for Bathroom safety products Vancouver, and we proudly include these in our service approach.
                </p>
                <p class="text-xl text-white/90 mb-8">
                    A lot of individuals fear slips, falls, or inaccessible places. We know these challenges. This is the reason why our services are based on comfort, support, and intelligent safety products. Our team listens, designs, and develops a bathroom that suits you using trusted bath and toilet safety accessories and supportive tools.
                </p>
    ...
    <section id="products" class="py-16 bg-gray-50">
        <div class="container mx-auto px-4">
            <div class="text-center mb-12">
                <h2 class="text-3xl font-bold text-gray-800 mb-4">Bathroom Safety Products Vancouver</h2>
                <p class="text-lg text-gray-600 max-w-3xl mx-auto">
                    We superciliously offer Bathroom safety products Vancouver that fit every style and budget. Families trust us for safe, simple, and useful upgrades.
                </p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
                ...
                <div
                    ...
                    <div class="p-6 flex-1 flex flex-col">
                        <h3 class="text-xl font-bold text-gray-800 mb-3">Shower Chairs</h3>
                        <p class="text-gray-600 mb-4 flex-grow">Comfortable and stable shower chairs make bathing easier and safer for seniors and individuals with mobility challenges.</p>
                        <div class="mt-auto">
                            <div class="block w-full bg-gray-200 text-gray-500 py-3 px-4 rounded-lg text-center font-medium cursor-not-allowed">
                                View Product
                            </div>
