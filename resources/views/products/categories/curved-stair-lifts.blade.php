            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div
                    ...
                    <div class="overflow-hidden relative">
                        <img src="{{ asset('al-prod-page-imgs/bruno-cre-2010 (2).png') }}" alt="Home2stay Freecurve Curved Stair Lift"
                ...
                <div
                    class="bg-white rounded-lg shadow-md overflow-hidden transition-all duration-300 hover:shadow-xl flex flex-col h-full">
                    <div class="overflow-hidden relative">
                        <img src="{{ asset('al-prod-page-imgs/Flow X_Main 35.jpg') }}" alt="Home2stay Straight Stair Lift 1100"
                            class="w-full object-cover" style="height: 400px;">
                    </div>
                    <div class="p-6 flex-1 flex flex-col">
