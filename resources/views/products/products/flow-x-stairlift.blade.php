...
@section('content')
                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-3">
                        ...
                        <li aria-current="page">
                            <div class="flex items-center">
                                ...
                                <span class="ml-1 font-medium text-gray-100">Flow X Curved Stairlift</span>
                            </div>
                        </li>
                    </ol>
                </nav>
                <h1 class="text-3xl md:text-4xl lg:text-5xl font-bold mb-4">Flow X Curved Stairlift Vancouver</h1>
            ...
            <div class="flex flex-col lg:flex-row gap-8">
                ...
                <div class="w-full lg:w-1/2">
                    <div class="bg-gray-100 rounded-lg overflow-hidden mb-4">
                        <img src="{{ asset('/flowx/Flow X_Main 10.jpg') }}"
                            alt="Flow X Curved Stairlift Vancouver" class="w-full h-auto object-contain p-4">
                    </div>
                ...
                <div class="w-full lg:w-1/2">
                    ...
                    <div class="mb-6">
                        <p class="text-gray-600 text-lg">
                            It changes flawlessly to the architecture of your home while matching your decor. The Flow X Home Lift System is a stylish and reliable way for you to be able to freely move around your home without having structural changes or compromises.
                        </p>
                    </div>
                    <div class="mb-6 p-4 bg-green-50 border-l-4 border-green-400 rounded-r-lg">
                        ...
                        <div class="space-y-1 text-green-700">
                            <p><strong>Contact us for custom pricing - Will be updated soon</strong></p>
                            <p class="text-sm">Each Flow X system is custom-designed for your specific staircase configuration</p>
                        </div>
                    </div>
                    <div class="mb-6 p-4 bg-blue-50 border-l-4 border-blue-400 rounded-r-lg">
                        <p class="text-blue-800 font-medium">
                            CONTACT US for a price quote customized to your curved staircase. Free, no-obligation on-site assessment available.
                        </p>
                    </div>
                    ...
                    <div class="mb-8 product-tabs">
                        ...
                        <div class="tab-content-container">
                            ...
                            <div class="tab-pane active" data-tab="features-tab" style="display: block !important;">
                                <div class="space-y-4">
                                    <div class="flex items-start">
                                        ...
                                        <div>
                                            <h3 class="font-semibold text-gray-800">Customized for Curved Stairs</h3>
                                            <p class="text-gray-600">Custom rail design crafted to fit every curve and twist. Handles complex angles, steep landings, and complicated shapes.</p>
                                        </div>
                                    </div>
                                    <div class="flex items-start">
                                        <svg class="h-5 w-5 text-primary flex-shrink-0 mr-3 mt-1"
                                        ...
                                        <div>
                                            <h3 class="font-semibold text-gray-800">Compact Design for Tight Spaces</h3>
                                            <p class="text-gray-600">Ideal for homes where space is limited. Folding seat, stairlift, and footrest minimize obstruction.</p>
                                        </div>
                                    </div>
                                    <div class="flex items-start">
                                        <svg class="h-5 w-5 text-primary flex-shrink-0 mr-3 mt-1"
                                        ...
                                        <div>
                                            <h3 class="font-semibold text-gray-800">Smooth and Silent Operation</h3>
                                            <p class="text-gray-600">Energy-efficient motor ensures quiet, smooth rides between floors with no jerks or vibrations.</p>
                                        </div>
                                    </div>
                                    <div class="flex items-start">
                                        <svg class="h-5 w-5 text-primary flex-shrink-0 mr-3 mt-1"
                                        ...
                                        <div>
                                            <h3 class="font-semibold text-gray-800">Elegant Finishes</h3>
                                            <p class="text-gray-600">Modern upholstery colors, premium materials, and rail finishes complement any interior decor.</p>
                                        </div>
                                    </div>
                                    <div class="flex items-start">
                                        <svg class="h-5 w-5 text-primary flex-shrink-0 mr-3 mt-1"
                                        ...
                                        <div>
                                            <h3 class="font-semibold text-gray-800">Reliable Safety Features</h3>
                                            <p class="text-gray-600">Integrated safety sensors, ergonomic seatbelts, and automatic stop mechanisms detect obstacles instantly.</p>
                                        </div>
                                    </div>
                                    <div class="flex items-start">
                                        <svg class="h-5 w-5 text-primary flex-shrink-0 mr-3 mt-1"
                                        ...
                                        <div>
                                            <h3 class="font-semibold text-gray-800">Automatic Swivel Technology</h3>
                                            <p class="text-gray-600">Entry and exit are effortless and secure, especially beneficial for the elderly or those with reduced mobility.</p>
                                        </div>
                                    </div>
                                    <div class="flex items-start">
                                        <svg class="h-5 w-5 text-primary flex-shrink-0 mr-3 mt-1"
                                        ...
                                        <div>
                                            <h3 class="font-semibold text-gray-800">Low Energy Consumption</h3>
                                            <p class="text-gray-600">Sustainable and cost-efficient operation for everyday use without high electricity costs.</p>
                                        </div>
                                    </div>
                                    <div class="flex items-start">
                                        <svg class="h-5 w-5 text-primary flex-shrink-0 mr-3 mt-1"
                                        ...
                                        <div>
                                            <h3 class="font-semibold text-gray-800">Flexible Configuration</h3>
                                            <p class="text-gray-600">Works on spiral, L-shaped, or split-level staircases with complete customization options.</p>
                                        </div>
                                    </div>
                                    <div class="flex items-start">
                                        <svg class="h-5 w-5 text-primary flex-shrink-0 mr-3 mt-1"
                                        ...
                                        <div>
                                            <h3 class="font-semibold text-gray-800">Professional Installation by Home2Stay</h3>
                                            <p class="text-gray-600">Factory-trained and fully certified installers ensure proper installation and safety compliance.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="tab-pane" data-tab="pricing-tab" style="display: none !important;">
                                <div class="space-y-6">
                                    ...
                                    <div class="bg-gray-50 rounded-lg p-4">
                                        <h4 class="text-lg font-semibold text-gray-800 mb-3">Complete Flow X Curved Stairlift Package</h4>
                                        <div class="space-y-3">
                                            <div class="flex justify-between items-center border-b pb-2">
                                                <span class="text-gray-700 font-medium">Custom Pricing:</span>
                                                <span class="font-semibold text-primary">Contact for Quote</span>
                                            </div>
                                            <div class="text-sm text-gray-600 mt-2">
                                                <p>* Custom fabrication for your specific staircase</p>
                                                <p>* Professional installation by certified technicians</p>
                                                <p>* Comprehensive warranty (parts and labor)</p>
                                                <p>* On-site measurement and assessment</p>
                                                <p>* Advanced safety features included</p>
                                                <p>* Premium materials and elegant finishes</p>
                                                <p>* Energy-efficient operation</p>
                                                <p>* Ongoing maintenance and support available</p>
                                                <p>* Free in-home consultation</p>
                                                <p><strong>Note:</strong> Pricing will be updated soon - Contact us for current rates</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="p-4 bg-green-50 border-l-4 border-green-400 rounded-r-lg">
                                        <p class="text-green-800 font-medium">
                                            Schedule a free on-site assessment and we'll provide a personalized quote for your curved staircase!
                                        </p>
                                    </div>

                                    <div class="p-4 bg-yellow-50 border-l-4 border-yellow-400 rounded-r-lg">
                                        <p class="text-yellow-800 font-medium">
                                            Restore independence and access to all levels of your home. Custom-designed curved stairlift solutions for Vancouver homes.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="tab-pane" data-tab="images-tab" style="display: none !important;">
                                <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
                                    <div class="image-thumbnail cursor-pointer">
                                        <img src="{{ asset('/flowx/Flow X_Main 10.jpg') }}"
                                            alt="Flow X Curved Stairlift"
                                            class="w-full h-32 object-contain rounded-lg hover:opacity-90 transition duration-200 p-2 bg-gray-50">
                                    </div>
                                    <div class="image-thumbnail cursor-pointer">
                                        <img src="{{ asset('/flowx/Flow X_Main 3.jpg') }}"
                                            alt="Flow X Curved Stairlift"
                                            class="w-full h-32 object-contain rounded-lg hover:opacity-90 transition duration-200 p-2 bg-gray-50">
                                    </div>
                                    <div class="image-thumbnail cursor-pointer">
                                        <img src="{{ asset('/flowx/Flow X_Main 4.jpg') }}"
                                            alt="Flow X Curved Stairlift"
                                            class="w-full h-32 object-contain rounded-lg hover:opacity-90 transition duration-200 p-2 bg-gray-50">
                                    </div>
                                    <div class="image-thumbnail cursor-pointer">
                                        <img src="{{ asset('/flowx/Flow X_Main 35.jpg') }}"
                                            alt="Flow X Curved Stairlift"
                                            class="w-full h-32 object-contain rounded-lg hover:opacity-90 transition duration-200 p-2 bg-gray-50">
                                    </div>
                                    <div class="image-thumbnail cursor-pointer">
                                        <img src="{{ asset('/flowx/Flow X_Main_Stages.jpg') }}"
                                            alt="Flow X Installation Stages"
                                            class="w-full h-32 object-contain rounded-lg hover:opacity-90 transition duration-200 p-2 bg-gray-50">
                                    </div>
                                    <div class="image-thumbnail cursor-pointer">
                                        <img src="{{ asset('/flowx/Flow X_Detail 2.jpg') }}"
                                            alt="Flow X Detail View"
                                            class="w-full h-32 object-contain rounded-lg hover:opacity-90 transition duration-200 p-2 bg-gray-50">
                                    </div>
                                    <div class="image-thumbnail cursor-pointer">
                                        <img src="{{ asset('/flowx/Flow X_Detail 10.jpg') }}"
                                            alt="Flow X Detail View"
                                            class="w-full h-32 object-contain rounded-lg hover:opacity-90 transition duration-200 p-2 bg-gray-50">
                                    </div>
                                    <div class="image-thumbnail cursor-pointer">
                                        <img src="{{ asset('/flowx/Flow X_Detail 25.jpg') }}"
                                            alt="Flow X Detail View"
                                            class="w-full h-32 object-contain rounded-lg hover:opacity-90 transition duration-200 p-2 bg-gray-50">
                                    </div>
                                    <div class="image-thumbnail cursor-pointer">
                                        <img src="{{ asset('/flowx/Flow X_Detail 35.jpg') }}"
                                            alt="Flow X Detail View"
                                            class="w-full h-32 object-contain rounded-lg hover:opacity-90 transition duration-200 p-2 bg-gray-50">
                                    </div>
                                    <div class="image-thumbnail cursor-pointer">
                                        <img src="{{ asset('/flowx/Flow X_Detail 40.jpg') }}"
                                            alt="Flow X Detail View"
                                            class="w-full h-32 object-contain rounded-lg hover:opacity-90 transition duration-200 p-2 bg-gray-50">
                                    </div>
                                </div>
                            ...
                            <div class="tab-pane" data-tab="technical-tab" style="display: none !important;">
                                <div class="mb-6">
                                    <div class="p-4 bg-yellow-50 border-l-4 border-yellow-400 rounded-r-lg mb-4">
                                        <p class="text-yellow-800 font-medium">
                                            <strong>Note:</strong> Detailed technical specifications will be updated soon. Each Flow X system is custom-designed for your specific staircase configuration.
                                        </p>
                                    </div>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div class="space-y-3">
                                            <div class="flex justify-between border-b pb-2">
                                                ...
                                                <span class="text-gray-600">Curved Stairlift</span>
                                            </div>
                                            <div class="flex justify-between border-b pb-2">
                                                <span class="font-medium text-gray-700">Installation Type:</span>
                                                <span class="text-gray-600">Custom curved rail</span>
                                            </div>
                                            <div class="flex justify-between border-b pb-2">
                                                <span class="font-medium text-gray-700">Rail System:</span>
                                                <span class="text-gray-600">Single rail design</span>
                                            </div>
                                            <div class="flex justify-between border-b pb-2">
                                                <span class="font-medium text-gray-700">Motor Type:</span>
                                                <span class="text-gray-600">Energy-efficient</span>
                                            </div>
                                            <div class="flex justify-between border-b pb-2">
                                                <span class="font-medium text-gray-700">Operation:</span>
                                                <span class="text-gray-600">Smooth & silent</span>
                                            </div>
                                            <div class="flex justify-between border-b pb-2">
                                                <span class="font-medium text-gray-700">Safety Features:</span>
                                                <span class="text-gray-600">Multiple sensors</span>
                                            </div>
                                        </div>
                                        <div class="space-y-3">
                                            <div class="flex justify-between border-b pb-2">
                                                <span class="font-medium text-gray-700">Seat Type:</span>
                                                <span class="text-gray-600">Folding with swivel</span>
                                            </div>
                                            <div class="flex justify-between border-b pb-2">
                                                <span class="font-medium text-gray-700">Seatbelt:</span>
                                                <span class="text-gray-600">Ergonomic design</span>
                                            </div>
                                            <div class="flex justify-between border-b pb-2">
                                            ...
                                            <div class="flex justify-between border-b pb-2">
                                                ...
                                                <span class="text-gray-600">Low voltage battery</span>
                                            </div>
                                            <div class="flex justify-between border-b pb-2">
                                                <span class="font-medium text-gray-700">Configuration:</span>
                                                <span class="text-gray-600">Spiral, L-shaped, split-level</span>
                                            </div>
                                            <div class="flex justify-between border-b pb-2">
                                ...
                                <div class="mb-8">
                                    <div class="bg-gray-50 rounded-lg p-4">
                                        <div class="flex items-center justify-between mb-2">
                                            ...
                                            <span class="text-sm text-gray-800">Contact for custom quote</span>
                                        </div>
                                        <div class="flex items-center justify-between mb-2">
    ...
    <!-- Why Choose Flow X Section -->
    <section class="py-16 bg-white">
        <div class="container mx-auto px-4">
            <div class="max-w-6xl mx-auto">
                <h2 class="text-3xl md:text-4xl font-bold text-center text-gray-800 mb-4">Why Choose Flow X Curved Stairlifts in Vancouver?</h2>
                <p class="text-center text-gray-600 text-lg mb-12">The Flow X Customized Curved Stairlifts is the latest generation of home accessibility solutions. Each model is customized to fit your staircase perfectly, while ensuring safety and perfect performance.</p>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
                    ...
                    <div class="bg-gray-50 rounded-lg p-6">
                        <h3 class="text-xl font-bold text-gray-800 mb-4">Flow X Stairlift Benefits</h3>
                        <ul class="space-y-2 text-gray-600">
                            <li class="flex items-start">
                                <svg class="h-5 w-5 text-primary flex-shrink-0 mr-2 mt-1" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                                </svg>
                                Restores independence with safe access to all levels
                            </li>
                            <li class="flex items-start">
                                <svg class="h-5 w-5 text-primary flex-shrink-0 mr-2 mt-1" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                                </svg>
                                Prevents falls and injuries with advanced sensors
                            </li>
                            <li class="flex items-start">
                                <svg class="h-5 w-5 text-primary flex-shrink-0 mr-2 mt-1" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                                </svg>
                                Increases property value through accessibility upgrades
                            </li>
                            <li class="flex items-start">
                                <svg class="h-5 w-5 text-primary flex-shrink-0 mr-2 mt-1" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                            ...
                            <li class="flex items-start">
                                ...
                                Works on spiral, L-shaped, or split-level staircases
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="bg-gray-50 rounded-lg p-8">
                    ...
                    <div class="space-y-6">
                        <div>
                            <h4 class="font-semibold text-gray-800 mb-2">What makes the Flow X Curved Stairlift different from other models?</h4>
                            <p class="text-gray-600">Unlike standard units, the Flow X Curved Stairlift uses an advanced single-rail system that fits almost any curved or multi-level staircase. Its compact seat, customizable design, and smooth ride distinguish it as one of the best stairlifts for curved stairs available today.</p>
                        </div>
                        <div>
                            <h4 class="font-semibold text-gray-800 mb-2">How long does a curved stairlift installation take in Vancouver?</h4>
                            <p class="text-gray-600">After your initial consultation, your custom rail is fabricated specifically for your staircase. Installation typically takes half a day, depending on staircase complexity and power access.</p>
                        </div>
                        <div>
                            <h4 class="font-semibold text-gray-800 mb-2">Can the Flow X be customized for tight or narrow stairs?</h4>
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">We recommend a professional maintenance check at least once a year. Our certified technicians inspect safety sensors, batteries, and drive components to ensure smooth operation and extend your stairlift's longevity.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-12 text-center">
                    <h3 class="text-2xl font-bold text-gray-800 mb-4">Areas We Serve Across Vancouver</h3>
                    <p class="text-gray-600 mb-4">Providing curved stairlift installation in Vancouver BC and surrounding communities:</p>
                    <div class="flex flex-wrap justify-center gap-3 text-sm text-gray-700">
                        <span class="px-4 py-2 bg-gray-100 rounded-full">Vancouver West Side</span>
                        <span class="px-4 py-2 bg-gray-100 rounded-full">Burnaby</span>
                        <span class="px-4 py-2 bg-gray-100 rounded-full">Richmond</span>
                        <span class="px-4 py-2 bg-gray-100 rounded-full">North Vancouver</span>
                        <span class="px-4 py-2 bg-gray-100 rounded-full">West Vancouver</span>
                        <span class="px-4 py-2 bg-gray-100 rounded-full">Coquitlam</span>
                        <span class="px-4 py-2 bg-gray-100 rounded-full">Surrey</span>
                        <span class="px-4 py-2 bg-gray-100 rounded-full">Langley</span>
                        <span class="px-4 py-2 bg-gray-100 rounded-full">Delta</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container mx-auto px-4">
            <div class="bg-gray-50 rounded-xl overflow-hidden shadow-lg">
                <div class="flex flex-col lg:flex-row">
                    ...
                    <!-- Image -->
                    <div class="w-full lg:w-1/2">
                        <img src="{{ asset('/flowx/Flow X_Main 35.jpg') }}" alt="Flow X Curved Stairlift Solutions"
                ...
                <form action="#" method="POST" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="location" name="location" placeholder="e.g., Main floor to upstairs, Basement stairs, etc."
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent">
                        </div>
                    </div>
                    ...
                    <!-- Staircase Type -->
                    <div class="mb-6">
                        <h4 class="text-lg font-semibold mb-3 text-primary">What type of staircase do you have?</h4>
                        <div class="bg-gray-50 p-4 rounded-lg">
                            <div class="grid grid-cols-2 gap-3">
                                <label class="flex items-center p-3 border border-gray-200 rounded-lg hover:bg-white cursor-pointer transition-colors">
                                    <input type="radio" name="staircase_type" value="curved" class="w-4 h-4 text-primary focus:ring-primary border-gray-300">
                                    <span class="ml-3 text-gray-700 font-medium">Curved</span>
                                </label>
                                <label class="flex items-center p-3 border border-gray-200 rounded-lg hover:bg-white cursor-pointer transition-colors">
                                    <input type="radio" name="staircase_type" value="spiral" class="w-4 h-4 text-primary focus:ring-primary border-gray-300">
                                    <span class="ml-3 text-gray-700 font-medium">Spiral</span>
                                </label>
                                <label class="flex items-center p-3 border border-gray-200 rounded-lg hover:bg-white cursor-pointer transition-colors">
                                    <input type="radio" name="staircase_type" value="l_shaped" class="w-4 h-4 text-primary focus:ring-primary border-gray-300">
                                    <span class="ml-3 text-gray-700 font-medium">L-Shaped</span>
                                </label>
                                <label class="flex items-center p-3 border border-gray-200 rounded-lg hover:bg-white cursor-pointer transition-colors">
                                    <input type="radio" name="staircase_type" value="split_level" class="w-4 h-4 text-primary focus:ring-primary border-gray-300">
                                    <span class="ml-3 text-gray-700 font-medium">Split-Level</span>
                                </label>
                                <label class="flex items-center p-3 border border-gray-200 rounded-lg hover:bg-white cursor-pointer transition-colors">
                                    <input type="radio" name="staircase_type" value="not_sure" class="w-4 h-4 text-primary focus:ring-primary border-gray-300">
                    ...
                    <!-- Features Interest -->
                    <div class="mb-6">
                        <h4 class="text-lg font-semibold mb-3 text-primary">Which features are most important to you?</h4>
                        <div class="bg-gray-50 p-4 rounded-lg">
                            <div class="space-y-3">
                                <label class="flex items-center p-3 border border-gray-200 rounded-lg hover:bg-white cursor-pointer transition-colors">
                                    <input type="checkbox" name="stairlift_features[]" value="compact_design" class="w-4 h-4 text-primary focus:ring-primary border-gray-300">
                                    <span class="ml-3 text-gray-700 font-medium">Compact Design for Tight Spaces</span>
                                </label>
                                <label class="flex items-center p-3 border border-gray-200 rounded-lg hover:bg-white cursor-pointer transition-colors">
                                    <input type="checkbox" name="stairlift_features[]" value="smooth_operation" class="w-4 h-4 text-primary focus:ring-primary border-gray-300">
                                    <span class="ml-3 text-gray-700 font-medium">Smooth & Silent Operation</span>
                                </label>
                                <label class="flex items-center p-3 border border-gray-200 rounded-lg hover:bg-white cursor-pointer transition-colors">
                                    <input type="checkbox" name="stairlift_features[]" value="elegant_finish" class="w-4 h-4 text-primary focus:ring-primary border-gray-300">
                                    <span class="ml-3 text-gray-700 font-medium">Elegant Finish to Match Decor</span>
                                </label>
                                <label class="flex items-center p-3 border border-gray-200 rounded-lg hover:bg-white cursor-pointer transition-colors">
                                    <input type="checkbox" name="stairlift_features[]" value="safety_sensors" class="w-4 h-4 text-primary focus:ring-primary border-gray-300">
                                    <span class="ml-3 text-gray-700 font-medium">Advanced Safety Sensors</span>
                                </label>
                                <label class="flex items-center p-3 border border-gray-200 rounded-lg hover:bg-white cursor-pointer transition-colors">
                                    <input type="checkbox" name="stairlift_features[]" value="not_sure" class="w-4 h-4 text-primary focus:ring-primary border-gray-300">
                    ...
                    <!-- Safety Concerns -->
                    <div class="mb-6">
                        <h4 class="text-lg font-semibold mb-3 text-primary">What are your primary safety concerns with stairs?</h4>
                        <div class="bg-gray-50 p-4 rounded-lg">
                            <div class="grid grid-cols-2 gap-3">
                                <label class="flex items-center p-3 border border-gray-200 rounded-lg hover:bg-white cursor-pointer transition-colors">
                                    <input type="checkbox" name="safety_concerns[]" value="fear_of_falling" class="w-4 h-4 text-primary focus:ring-primary border-gray-300">
                                    <span class="ml-3 text-gray-700 font-medium">Fear of Falling on Stairs</span>
                                </label>
                                <label class="flex items-center p-3 border border-gray-200 rounded-lg hover:bg-white cursor-pointer transition-colors">
                                    <input type="checkbox" name="safety_concerns[]" value="steep_stairs" class="w-4 h-4 text-primary focus:ring-primary border-gray-300">
                                    <span class="ml-3 text-gray-700 font-medium">Steep or Narrow Stairs</span>
                                </label>
                                <label class="flex items-center p-3 border border-gray-200 rounded-lg hover:bg-white cursor-pointer transition-colors">
                                    <input type="checkbox" name="safety_concerns[]" value="difficulty_climbing" class="w-4 h-4 text-primary focus:ring-primary border-gray-300">
                                    <span class="ml-3 text-gray-700 font-medium">Difficulty Climbing Stairs</span>
                                </label>
                                <label class="flex items-center p-3 border border-gray-200 rounded-lg hover:bg-white cursor-pointer transition-colors">
                                    <input type="checkbox" name="safety_concerns[]" value="balance_issues" class="w-4 h-4 text-primary focus:ring-primary border-gray-300">
                                    <span class="ml-3 text-gray-700 font-medium">Balance/Stability Issues</span>
                                </label>
                                <label class="flex items-center p-3 border border-gray-200 rounded-lg hover:bg-white cursor-pointer transition-colors">
                                    <input type="checkbox" name="safety_concerns[]" value="loss_of_access" class="w-4 h-4 text-primary focus:ring-primary border-gray-300">
                                    <span class="ml-3 text-gray-700 font-medium">Loss of Access to Upper Floors</span>
                                </label>
                                <label class="flex items-center p-3 border border-gray-200 rounded-lg hover:bg-white cursor-pointer transition-colors">
                                    <input type="checkbox" name="safety_concerns[]" value="previous_fall" class="w-4 h-4 text-primary focus:ring-primary border-gray-300">
                                    <span class="ml-3 text-gray-700 font-medium">Previous Fall on Stairs</span>
                                </label>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="bg-gray-50 p-4 rounded-lg">
                            <div class="space-y-3">
                                <label class="flex items-center p-3 border border-gray-200 rounded-lg hover:bg-white cursor-pointer transition-colors">
                                    ...
                                    <span class="ml-3 text-gray-700 font-medium">Purchase Flow X Curved Stairlift</span>
                                </label>
                                <label class="flex items-center p-3 border border-gray-200 rounded-lg hover:bg-white cursor-pointer transition-colors">
                                    <input type="radio" name="interest_type" value="assessment" class="w-4 h-4 text-primary focus:ring-primary border-gray-300">
                                    <span class="ml-3 text-gray-700 font-medium">Free On-Site Assessment Only</span>
                                </label>
                                <label class="flex items-center p-3 border border-gray-200 rounded-lg hover:bg-white cursor-pointer transition-colors">
                    ...
                    <div>
                        ...
                        <textarea id="comments" name="comments" rows="3"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent"
                            placeholder="Please describe your staircase configuration, any specific challenges, or questions about the Flow X Curved Stairlift..."></textarea>
                    </div>
                ...
                <form id="quoteRequestForm">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="p-3 bg-gray-50 rounded-lg mb-4">
                            <p>You're requesting a quote for: <span class="font-semibold text-primary">Flow X Curved Stairlift</span></p>
                            <p class="text-sm text-gray-600 mt-1">Custom curved stairlift solutions for Vancouver homes - Free on-site assessment available</p>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <label class="block text-gray-700 font-medium mb-2" for="modal_location">Staircase Location</label>
                            <input type="text" id="modal_location" name="location" placeholder="e.g., Main floor to upstairs, Basement stairs, etc."
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent">
                        </div>
                                <!-- Staircase Type -->
                    <div class="mb-6">
                        ...
                        <div class="bg-gray-50 p-4 rounded-lg">
                            <div class="grid grid-cols-2 gap-3">
                                <label class="flex items-center p-3 border border-gray-200 rounded-lg hover:bg-white cursor-pointer transition-colors">
                                    <input type="radio" name="modal_staircase_type" value="curved" class="w-4 h-4 text-primary focus:ring-primary border-gray-300">
                                    <span class="ml-3 text-gray-700 font-medium">Curved</span>
                                </label>
                                <label class="flex items-center p-3 border border-gray-200 rounded-lg hover:bg-white cursor-pointer transition-colors">
                                    <input type="radio" name="modal_staircase_type" value="spiral" class="w-4 h-4 text-primary focus:ring-primary border-gray-300">
                                    <span class="ml-3 text-gray-700 font-medium">Spiral</span>
                                </label>
                                <label class="flex items-center p-3 border border-gray-200 rounded-lg hover:bg-white cursor-pointer transition-colors">
                                    <input type="radio" name="modal_staircase_type" value="l_shaped" class="w-4 h-4 text-primary focus:ring-primary border-gray-300">
                                    <span class="ml-3 text-gray-700 font-medium">L-Shaped</span>
                                </label>
                                <label class="flex items-center p-3 border border-gray-200 rounded-lg hover:bg-white cursor-pointer transition-colors">
                                    <input type="radio" name="modal_staircase_type" value="not_sure" class="w-4 h-4 text-primary focus:ring-primary border-gray-300">
                                    <span class="ml-3 text-gray-700 font-medium">Not Sure</span>
                                </label>
                            </div>
                        </div>
