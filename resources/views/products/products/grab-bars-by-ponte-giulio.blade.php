                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-3">
                        ...
                        <li aria-current="page">
                            <div class="flex items-center">
                                ...
                                <span class="ml-1 font-medium text-gray-100">Ponte Giulio</span>
                            </div>
                        </li>
                    </ol>
                </nav>
                <h1 class="text-3xl md:text-4xl lg:text-5xl font-bold mb-4">Home2stay | Grab Bars by Ponte Giulio</h1>
                ...
                <div class="w-full lg:w-1/2">
                    <div class="mb-6">
                        <p class="text-gray-600 text-lg">
                            Ensure confidence, independence, and style in your home with Ponte Giulio Grab Bars, available at Home2stay. Designed to provide unmatched support, these grab bars combine durability, safety, and modern aesthetics, making them a perfect addition to any bathroom or living space.
                        </p>
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <ul class="text-gray-600 text-lg space-y-2">
                            ...
                            <li><strong>Stylish Options:</strong> Available in a variety of finishes, chrome, brushed nickel, and matte white, to seamlessly match your interior decor.</li>
                    ...
                    <div class="mb-6 p-4 bg-blue-50 border-l-4 border-blue-400 rounded-r-lg">
                        <h3 class="font-semibold text-blue-800 mb-2">Why Choose Ponte Giulio?</h3>
                        <div class="space-y-1 text-blue-700">
                            <p><strong>Ponte Giulio is renowned for combining innovative design with top-tier safety standards. Each grab bar comes with a trusted warranty and our commitment to high-quality customer service.</strong></p>
                        </div>
                    </div>
                                ...
                                <div class="space-y-4">
                                    <div class="flex items-start">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-gray-600">Crafted from high-quality stainless steel and corrosion-resistant finishes, ensuring long-lasting performance even in wet environments.</p>
                                        </div>
                                    </div>
                                    <div class="flex items-start">
                                        <svg class="h-5 w-5 text-primary flex-shrink-0 mr-3 mt-1"
                                        ...
                                        <div>
                                            <h3 class="font-semibold text-gray-800">Ergonomic Design</h3>
                                            <p class="text-gray-600">Rounded edges and comfortable grip surfaces provide maximum safety and ease of use.</p>
                                        </div>
                                    </div>
                                    <div class="flex items-start">
                                        <svg class="h-5 w-5 text-primary flex-shrink-0 mr-3 mt-1"
                                    ...
                                    <div class="flex items-start">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-gray-600">Simple mounting hardware included, designed for secure and stable installation on walls.</p>
                                        </div>
                                    </div>
                                    <div class="flex items-start">
                                        <svg class="h-5 w-5 text-primary flex-shrink-0 mr-3 mt-1"
                                        ...
                                        <div>
                                            <h3 class="font-semibold text-gray-800">Versatile Sizes</h3>
                                            <p class="text-gray-600">Multiple lengths and configurations to suit any bathroom layout or accessibility need.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="container mx-auto px-4">
            <div class="max-w-4xl mx-auto bg-white rounded-xl shadow-lg p-8 md:p-12">
                ...
                <form action="/submit-product-inquiry" method="POST" class="space-y-6">
                    ...
                    <!-- Grab Bar Location -->
                    <div class="mb-6">
                        <h4 class="text-lg font-semibold mb-3 text-primary">Where do you need grab bars?</h4>
                ...
                <form id="quoteRequestForm" action="/submit-product-inquiry" method="POST">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="p-3 bg-gray-50 rounded-lg mb-4">
                            <p>You're requesting a quote for: <span class="font-semibold text-primary">Ponte Giulio Grab Bars</span></p>
                            <p class="text-sm text-gray-600 mt-1">Premium stainless steel grab bars with multiple finishes and custom order options available</p>
                        </div>
                    </div>
