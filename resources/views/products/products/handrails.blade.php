                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-3">
                        ...
                        <li aria-current="page">
                            <div class="flex items-center">
                                ...
                                <span class="ml-1 font-medium text-gray-100"> Handrails</span>
                            </div>
                        </li>
                    </ol>
                </nav>
                <h1 class="text-3xl md:text-4xl lg:text-5xl font-bold mb-4"> Handrails - Safety Meets Sophistication</h1>
                        ...
                        <div class="tab-content-container">
                            ...
                            <div class="tab-pane" data-tab="images-tab" style="display: none !important;">
                                <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
                                    ...
                                    <div class="image-thumbnail cursor-pointer">
                                        <img src="{{ asset('grabbars/handrails-2.avif') }}"
                                            alt="Home2stay Tub Cut Ultra-Low"
                                            class="w-full h-32 object-contain rounded-lg hover:opacity-90 transition duration-200 p-2 bg-gray-50">
                                    </div>
                                    <div class="image-thumbnail cursor-pointer">
                                        <img src="{{ asset('grabbars/handrails-3.webp') }}"
                                            alt="Home2stay Tub Cut Ultra-Low"
                                            class="w-full h-32 object-contain rounded-lg hover:opacity-90 transition duration-200 p-2 bg-gray-50">
                                    </div>
                                </div>
        ...
        <div class="container mx-auto px-4">
            <div class="bg-gray-50 rounded-xl overflow-hidden shadow-lg">
                <div class="flex flex-col lg:flex-row">
                    ...
                    <!-- Image -->
                    <div class="w-full lg:w-1/2">
                        <img src="{{ asset('grabbars/handrails-3.webp') }}" alt="Bathroom Safety Solutions"
