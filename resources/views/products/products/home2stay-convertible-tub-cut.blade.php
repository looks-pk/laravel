                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-3">
                        ...
                        <li aria-current="page">
                            <div class="flex items-center">
                                ...
                                <span class="ml-1 font-medium text-gray-100">Home2stay Convertible Tub Cut</span>
                            </div>
                        </li>
                    </ol>
                </nav>
                <h1 class="text-3xl md:text-4xl lg:text-5xl font-bold mb-4">Home2stay Convertible Tub Cut</h1>
                ...
                <div class="w-full lg:w-1/2">
                    ...
                    <div class="mb-6">
                        <p class="text-gray-600 text-lg">
                            The CleanCut Convertible features a non-skid step pad, and an easy-to-use waterproof removable plug center for easy transition between step-in shower and full bath.
                        </p>
                    </div>
                    <div class="mb-6">
                        <p class="text-gray-600 text-lg">
                    ...
                    <div class="mb-6 p-4 bg-green-50 border-l-4 border-green-400 rounded-r-lg">
                        ...
                        <div class="space-y-1 text-green-700">
                            <p><strong>Starts at $1,395</strong> including installation and water test after 48 hours</p>
                        </div>
                    </div>
                    <div class="mb-6 p-4 bg-blue-50 border-l-4 border-blue-400 rounded-r-lg">
                        <p class="text-blue-800 font-medium">
                            Flexibility to meet your changing needs - configure as traditional tub or step-in tub. Available for NEXT-DAY delivery and installation!
                        </p>
                    </div>
                            ...
                            <div class="tab-pane active" data-tab="features-tab" style="display: block !important;">
                                <div class="space-y-4">
                                    <div class="flex items-start">
                                        ...
                                        <div>
                                            <h3 class="font-semibold text-gray-800">Dual Configuration Design</h3>
                                            <p class="text-gray-600">Enjoy the best of both worlds - convert your existing tub into a step-in shower or traditional bath with easy transition.</p>
                                        </div>
                                    </div>
                                    <div class="flex items-start">
                                        <svg class="h-5 w-5 text-primary flex-shrink-0 mr-3 mt-1"
                                        ...
                                        <div>
                                            <h3 class="font-semibold text-gray-800">Waterproof Removable Plug</h3>
                                            <p class="text-gray-600">Features an easy-to-use waterproof removable plug center for seamless transition between step-in shower and full bath.</p>
                                        </div>
                                    </div>
                                    <div class="flex items-start">
                                        <svg class="h-5 w-5 text-primary flex-shrink-0 mr-3 mt-1"
                                        ...
                                        <div>
                                            ...
                                            <p class="text-gray-600">Conveniently installed within 2-4 hours with minimal disruption to your home.</p>
                                        </div>
                                    </div>
                                    <div class="flex items-start">
                                        <svg class="h-5 w-5 text-primary flex-shrink-0 mr-3 mt-1"
                                    ...
                                    <div class="flex items-start">
                                        ...
                                        <div>
                                            <h3 class="font-semibold text-gray-800">Flexible Width Option</h3>
                                            <p class="text-gray-600">Available in 1 standard width designed to fit most bathtub configurations.</p>
                                        </div>
                                    </div>
                                    <div class="flex items-start">
                                        <svg class="h-5 w-5 text-primary flex-shrink-0 mr-3 mt-1"
                                    ...
                                    <div class="flex items-start">
                                        ...
                                        <div>
                                            <h3 class="font-semibold text-gray-800">Quick Lock/Unlock System</h3>
                                            <p class="text-gray-600">Removable unit locks and unlocks quickly for easy configuration changes.</p>
                                        </div>
                                    </div>
                                    <div class="flex items-start">
                                        <svg class="h-5 w-5 text-primary flex-shrink-0 mr-3 mt-1"
                                        ...
                                        <div>
                                            <h3 class="font-semibold text-gray-800">Adaptable to Changing Needs</h3>
                                            <p class="text-gray-600">Flexibility to meet your changing needs - perfect for families with varying accessibility requirements.</p>
                                        </div>
                                    </div>
                                    <div class="flex items-start">
                                        <svg class="h-5 w-5 text-primary flex-shrink-0 mr-3 mt-1"
                                        ...
                                        <div>
                                            ...
                                            <p class="text-gray-600">Installation completed on existing tub by CleanCut specialists with 48-hour water test included.</p>
                                        </div>
                                    </div>
                                    <div class="flex items-start">
                                        <svg class="h-5 w-5 text-primary flex-shrink-0 mr-3 mt-1"
                            ...
                            <div class="tab-pane" data-tab="pricing-tab" style="display: none !important;">
                                <div class="space-y-6">
                                    ...
                                    <div class="bg-gray-50 rounded-lg p-4">
                                        <h4 class="text-lg font-semibold text-gray-800 mb-3">Complete Convertible Tub Cut Package</h4>
                                        <div class="space-y-3">
                                            <div class="flex justify-between items-center border-b pb-2">
                                                <span class="text-gray-700 font-medium">Starting Price:</span>
                                                <span class="font-semibold text-primary">$1,395</span>
                                            </div>
                                            <div class="text-sm text-gray-600 mt-2">
                                                <p>* Price includes the Home2stay Convertible Tub Cut</p>
                                                <p>* Professional installation included</p>
                                                <p>* CleanCut quality and reliability</p>
                                                <p>* Waterproof removable plug center included</p>
                                                <p>* Non-skid step pad included</p>
                                                <p>* Water test after 48 hours included</p>
                                                <p>* Available in white and beige colors</p>
                                                <p>* Dual configuration capability</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="p-4 bg-green-50 border-l-4 border-green-400 rounded-r-lg">
                                        <p class="text-green-800 font-medium">
                                            Complete package starting at $1,395 including installation and water test after 48 hours. The best of both worlds!
                                        </p>
                                    </div>
                            ...
                            <div class="tab-pane" data-tab="images-tab" style="display: none !important;">
                                <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
                                    <div class="image-thumbnail cursor-pointer">
                                        <img src="{{ asset('bathsafety-cat/CleanCut-Convertible-wPlug-V3-e1503607459913.jpg') }}"
                                            alt="Home2stay Convertible Tub Cut"
                                            class="w-full h-32 object-contain rounded-lg hover:opacity-90 transition duration-200 p-2 bg-gray-50">
                                    </div>
                                    <div class="image-thumbnail cursor-pointer">
                                        <img src="{{ asset('bathsafety-cat/Convertable-tub-cut-1.png') }}"
                                            alt="CleanCut Convertible Installation"
                                            class="w-full h-32 object-contain rounded-lg hover:opacity-90 transition duration-200 p-2 bg-gray-50">
                                    </div>
                                    <div class="image-thumbnail cursor-pointer">
                                        <img src="{{ asset('bathsafety-cat/CleanCut-Convertible-Closeup-with-Plug-500x333-1-e1640791849682.jpg') }}"
                                            alt="CleanCut Convertible Installation"
                                            class="w-full h-32 object-contain rounded-lg hover:opacity-90 transition duration-200 p-2 bg-gray-50">
                                    </div>
                                    <div class="image-thumbnail cursor-pointer">
                                        <img src="{{ asset('bathsafety-cat/Convertible-tub-cut-1.jpg') }}"
                                            alt="CleanCut Convertible Installation"
                                            class="w-full h-32 object-contain rounded-lg hover:opacity-90 transition duration-200 p-2 bg-gray-50">
                                    </div>
                                </div>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div class="space-y-3">
                                            <div class="flex justify-between border-b pb-2">
                                                ...
                                                <span class="text-gray-600">Convertible Tub Cut</span>
                                            </div>
                                            <div class="flex justify-between border-b pb-2">
                                            ...
                                            <div class="flex justify-between border-b pb-2">
                                                ...
                                                <span class="text-gray-600">1 standard width</span>
                                            </div>
                                            <div class="flex justify-between border-b pb-2">
                                        ...
                                        <div class="space-y-3">
                                            ...
                                            <div class="flex justify-between border-b pb-2">
                                                ...
                                                <span class="text-gray-600">Traditional tub or step-in shower</span>
                                            </div>
                                            <div class="flex justify-between border-b pb-2">
                                                <span class="font-medium text-gray-700">Special Feature:</span>
                                                <span class="text-gray-600">Waterproof removable plug</span>
                                            </div>
                                            <div class="flex justify-between border-b pb-2">
                                                <span class="font-medium text-gray-700">Lock System:</span>
                                                <span class="text-gray-600">Quick lock and unlock</span>
                                            </div>
                                            <div class="flex justify-between border-b pb-2">
                                                <span class="font-medium text-gray-700">Flexibility:</span>
                                                <span class="text-gray-600">Meets changing needs</span>
                                            </div>
                                            <div class="flex justify-between border-b pb-2">
                                ...
                                <div class="mb-8">
                                    <div class="bg-gray-50 rounded-lg p-4">
                                        <div class="flex items-center justify-between mb-2">
                                            ...
                                            <span class="text-sm text-gray-800">Starts at $1,395 including installation and water test after 48 hours</span>
                                        </div>
                                        <div class="flex items-center justify-between mb-2">
        ...
        <div class="container mx-auto px-4">
            <div class="max-w-4xl mx-auto bg-white rounded-xl shadow-lg p-8 md:p-12">
                ...
                <form action="#" method="POST" class="space-y-6">
                    @csrf
                    <input type="hidden" name="product" value="Home2stay Convertible Tub Cut">
                        ...
                        <div class="bg-gray-50 p-4 rounded-lg">
                            <div class="space-y-3">
                                <label class="flex items-center p-3 border border-gray-200 rounded-lg hover:bg-white cursor-pointer transition-colors">
                                    ...
                                    <span class="ml-3 text-gray-700 font-medium">Standard Width (fits most tubs)</span>
                                </label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea id="comments" name="comments" rows="3"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent"
                            placeholder="Please describe your bathtub dimensions, mobility needs, or any questions about the Home2stay Convertible Tub Cut..."></textarea>
                    </div>
        ...
        <div class="relative bg-white rounded-lg max-w-2xl w-full mx-auto max-h-[90vh] overflow-y-auto">
            ...
            <div class="p-6">
                <form id="quoteRequestForm">
                    @csrf
                    <input type="hidden" id="product_name" name="product_name" value="Home2stay Convertible Tub Cut">

                    <!-- Product Info Section -->
                    <div class="mb-6">
                        <h4 class="text-lg font-semibold mb-4 text-primary">Product Information</h4>
                        <div class="p-3 bg-gray-50 rounded-lg mb-4">
                            <p>You're requesting a quote for: <span class="font-semibold text-primary">Home2stay Convertible Tub Cut</span></p>
                            <p class="text-sm text-gray-600 mt-1">Starting at $1,395 including installation and water test after 48 hours</p>
                        </div>
                    </div>
