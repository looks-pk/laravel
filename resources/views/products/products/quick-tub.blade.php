                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-3">
                        ...
                        <li aria-current="page">
                            <div class="flex items-center">
                                ...
                                <span class="ml-1 font-medium text-gray-100">Quick Tub</span>
                            </div>
                        </li>
                    </ol>
                </nav>
                <h1 class="text-3xl md:text-4xl lg:text-5xl font-bold mb-4">Home2stay – Accessibility / Tub Cuts Quick Tub</h1>
                ...
                <div class="w-full lg:w-1/2">
                    <div class="bg-gray-100 rounded-lg overflow-hidden mb-4">
                        <img src="{{ asset('bathsafety-cat/CleanCut-Step-V1-e1503607014281-1.jpg') }}"
                            alt="Quick Tub" class="w-full h-auto object-contain p-4">
                    </div>
                ...
                <div class="w-full lg:w-1/2">
                    <div class="mb-6">
                        <p class="text-gray-600 text-lg">
                            Quick Tub services turns your standard bathtub into a low-threshold step-in shower without the cost, mess or time of a complete renovation. Designed for comfort, safety and everyday independence, this smart bathroom modification empowers people of all ages and mobility levels to move confidently in and out of the tub.
                        </p>
                    </div>

                    <div class="mb-6">
                        <h4 class="font-semibold text-gray-800 mb-3">What It Is:</h4>
                        <p class="text-gray-600 text-lg">
                            Quick tub is a premium tub-to-shower conversion system that modifies your existing bathtub by cutting down a section of the tub wall and installing a walk-through insert or step-in panel. This creates a low-entry threshold that dramatically improves accessibility, making showers safer and more comfortable for seniors, people with mobility challenges, or anyone who struggles with high tub walls.
                        </p>
                    </div>

                    <div class="mb-6 p-4 bg-blue-50 border-l-4 border-blue-400 rounded-r-lg">
                        <h3 class="font-semibold text-blue-800 mb-2">Smart Bathroom Accessibility</h3>
                        <div class="space-y-1 text-blue-700">
                            <p><strong>Home2Stay Quick Tub offers affordable, fast tub-to-shower conversion without major renovation, enabling independent living and daily confidence.</strong></p>
                        </div>
                    </div>
                                ...
                                <div class="space-y-4">
                                    <div class="flex items-start">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-gray-600">Convert your existing tub into a step-in shower - perfect solution for high-profile bathtubs.</p>
                                        </div>
                                    </div>
                                    <div class="flex items-start">
                                        <svg class="h-5 w-5 text-primary flex-shrink-0 mr-3 mt-1"
                                        ...
                                        <div>
                                            <h3 class="font-semibold text-gray-800">Ultra-Low Profile Design</h3>
                                            <p class="text-gray-600">Specifically designed for high-profile tubs (at least 14.75" tall) - creates an ultra-low step-in threshold.</p>
                                        </div>
                                    </div>
                                    <div class="flex items-start">
                                        <svg class="h-5 w-5 text-primary flex-shrink-0 mr-3 mt-1"
                                    ...
                                    <div class="flex items-start">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-gray-600">Works with existing acrylic, fiberglass, steel or cast iron bathtubs that are at least 14.75" tall.</p>
                                        </div>
                                    </div>
                                    <div class="flex items-start">
                                        <svg class="h-5 w-5 text-primary flex-shrink-0 mr-3 mt-1"
                                        ...
                                        <div>
                                            <h3 class="font-semibold text-gray-800">Single Width Design</h3>
                                            <p class="text-gray-600">Available in 1 width specifically designed for high-profile bathtub configurations.</p>
                                        </div>
                                    </div>
                                    <div class="flex items-start">
                                        <svg class="h-5 w-5 text-primary flex-shrink-0 mr-3 mt-1"
                                    ...
                                    <div class="flex items-start">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-gray-600">Installation completed on existing tub by CleanCut specialists in less than one day.</p>
                                        </div>
                                    </div>
                                    <div class="flex items-start">
                                        <svg class="h-5 w-5 text-primary flex-shrink-0 mr-3 mt-1"
        ...
        <div class="container mx-auto px-4">
            <div class="bg-gray-50 rounded-xl overflow-hidden shadow-lg">
                <div class="flex flex-col lg:flex-row">
                    ...
                    <!-- Image -->
                    <div class="w-full lg:w-1/2">
                        <img src="{{ asset('/bathsafety-cat/CleanCut-Convertible-wPlug-V3-e1503607459913.jpg') }}" alt="Bathroom Safety Solutions"
