                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-3">
                        ...
                        <li aria-current="page">
                            <div class="flex items-center">
                                ...
                                <span class="ml-1 font-medium text-gray-100"> Tub Cut Step</span>
                            </div>
                        </li>
                    </ol>
                </nav>
                <h1 class="text-3xl md:text-4xl lg:text-5xl font-bold mb-4"> Tub Cut Step</h1>
                                ...
                                <div class="mb-6">
                                    ...
                                    <div class="bg-gray-50 rounded-lg p-4">
                                        <ul class="text-gray-700 text-sm leading-relaxed space-y-2">
                                            <li>â€¢ Step-in shower conversion for existing tubs</li>
                                            ...
                                            <li>â€¢ Available in 3 widths to fit various tub sizes</li>
