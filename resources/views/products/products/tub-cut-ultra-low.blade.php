...
@section('title', 'Home2stay Tub Cut Ultra-Low - Home2stay')
@section('meta_description', 'Ultra-Low is ideal for high-profile tubs and features non-skid step pad. Product comes in two colors (white and beige).')
                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-3">
                        ...
                        <li aria-current="page">
                            <div class="flex items-center">
                                ...
                                <span class="ml-1 font-medium text-gray-100"> Tub Cut Ultra-Low</span>
                            </div>
                        </li>
                    </ol>
                </nav>
                <h1 class="text-3xl md:text-4xl lg:text-5xl font-bold mb-4"> Tub Cut Ultra-Low</h1>
            ...
            <div class="flex flex-col lg:flex-row gap-8">
                ...
                <div class="w-full lg:w-1/2">
                    <div class="bg-gray-100 rounded-lg overflow-hidden mb-4">
                        <img src="{{ asset('tubcuts/ultra-low-tubcut.jpeg') }}"
                            alt="Home2stay Tub Cut Ultra-Low" class="w-full h-auto object-contain p-4">
                    </div>
                ...
                <div class="w-full lg:w-1/2">
                    ...
                    <div class="mb-6">
                        <p class="text-gray-600 text-lg">
                            The CleanCut Ultra-Low is ideal for high-profile tubs (at least 14.75" tall).
                        </p>
                    </div>
                    <div class="mb-6">
                        <p class="text-gray-600 text-lg">
                    ...
                    <div class="mb-6">
                        <p class="text-gray-600 text-lg">
                            Conveniently installed within a few hours into your existing acrylic, fiberglass, steel or cast iron bathtub. Available in 1 width and two color options: white and beige. Available for NEXT-DAY delivery and installation via the Home2Stay Express booking form!
                        </p>
                    </div>
                    <div class="mb-6 p-4 bg-green-50 border-l-4 border-green-400 rounded-r-lg">
                        ...
                        <div class="space-y-1 text-green-700">
                            <p><strong>Starts at $1,150</strong> including installation</p>
                        </div>
                    </div>
                    <div class="mb-6 p-4 bg-blue-50 border-l-4 border-blue-400 rounded-r-lg">
                        <p class="text-blue-800 font-medium">
                            Ideal for high-profile tubs - enables easy step-in access. Our most affordable product for taller bathtubs!
                        </p>
                    </div>
                        ...
                        <div class="tab-content-container">
                            ...
                            <div class="tab-pane" data-tab="images-tab" style="display: none !important;">
                                <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
                                    ...
                                    <div class="image-thumbnail cursor-pointer">
                                        <img src="{{ asset('tubcuts/ultra-low-tubcut1.jpeg') }}"
                                            alt="Home2stay Tub Cut Ultra-Low"
                                            class="w-full h-32 object-contain rounded-lg hover:opacity-90 transition duration-200 p-2 bg-gray-50">
                                    </div>
                                    <div class="image-thumbnail cursor-pointer">
                                        <img src="{{ asset('tubcuts/ultra-low-tubcut2.jpeg') }}"
                                            alt="Home2stay Tub Cut Ultra-Low"
                                            class="w-full h-32 object-contain rounded-lg hover:opacity-90 transition duration-200 p-2 bg-gray-50">
                                    </div>
                                    <div class="image-thumbnail cursor-pointer">
                                        <img src="{{ asset('tubcuts/ultra-low-tubcut3.jpeg') }}"
                                            alt="Home2stay Tub Cut Ultra-Low"
                                            class="w-full h-32 object-contain rounded-lg hover:opacity-90 transition duration-200 p-2 bg-gray-50">
                                    </div>
                                    <div class="image-thumbnail cursor-pointer">
                                        <img src="{{ asset('tubcuts/ultra-low-tubcut4.jpeg') }}"
                                            alt="Home2stay Tub Cut Ultra-Low"
                                            class="w-full h-32 object-contain rounded-lg hover:opacity-90 transition duration-200 p-2 bg-gray-50">
                                    </div>
                                </div>
        ...
        <div class="container mx-auto px-4">
            <div class="bg-gray-50 rounded-xl overflow-hidden shadow-lg">
                <div class="flex flex-col lg:flex-row">
                    ...
                    <!-- Image -->
                    <div class="w-full lg:w-1/2">
                        <img src="{{ asset('tubcuts/ultra-low-tubcut5.jpeg') }}" alt="Bathroom Safety Solutions"
