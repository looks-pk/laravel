            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div
                    ...
                    <div class="overflow-hidden relative">
                        <img src="{{ asset('rentals-main/Home2stay-Bath-Lifter-rentals-category-min.jpg') }}" alt="Automotive"
    ...
    <section class="py-16 bg-secondary bg-opacity-10">
        <div class="container mx-auto px-4">
            <div class="text-center max-w-3xl mx-auto mb-12">
                ...
                <p class="text-lg text-gray-600">Our simple rental process makes it easy to get the accessibility equipment you need.</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="bg-white rounded-lg shadow-lg overflow-hidden transform transition duration-300 hover:shadow-xl hover:-translate-y-1">
                    ...
                    <div class="p-8 text-center">
                        <div class="w-16 h-16 bg-primary bg-opacity-10 rounded-full mx-auto flex items-center justify-center mb-4">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                            </svg>
                        </div>
                        <p class="text-gray-600">Browse through our list of items available for rental. You can take note of which accessibility solutions cater best to your needs. You can also list down any questions you have for us as well.</p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-lg overflow-hidden transform transition duration-300 hover:shadow-xl hover:-translate-y-1">
                    ...
                    <div class="p-8 text-center">
                        ...
                        <p class="text-gray-600">Call Home2stay at 604.259.1211. During this call, you can tell our staff what items you need to rent from our list. Our staff will set an installation schedule for you. You can also submit a Free Assessment Form.</p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-lg overflow-hidden transform transition duration-300 hover:shadow-xl hover:-translate-y-1">
                    ...
                    <div class="p-8 text-center">
                        ...
                        <p class="text-gray-600">Wait for your installation schedule. If you'll need to make changes to this, please inform Home2stay immediately so that we can reschedule our appointment with you.</p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-lg overflow-hidden transform transition duration-300 hover:shadow-xl hover:-translate-y-1">
                    ...
                    <div class="p-8 text-center">
                        ...
                        <p class="text-gray-600">Using your preferred payment method, pay for the following upon installation: setup fees, removal fees, and first-month rental fee.</p>
                    </div>
                </div>
            </div>
        </div>
